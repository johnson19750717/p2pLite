        ...
        view: {
            ...
            showHistoryFront: function(json) {
                ...
                for(var i = 0, l= json.length; i < l; i++) {
                    ...
                    tr.find('td[class="history-file-front"] a').attr('data-url', demo.config.apiPath + '/resources/' + json[i].source + '.jpg');
            ...
            showHistoryBack: function(json) {
                ...
                for(var i = 0, l= json.length; i < l; i++) {
                    tr = $('<tr></tr>').html(template);
                    tr.find('td[class="history-file-back"] a').attr('data-url', demo.config.apiPath + '/resources/' + json[i].source + '.jpg');
